...
<template>
  <div class="">
    ...
    <el-table :data="tableData" style="width: 100%">
      ...
      <el-table-column prop="zongchangdu" label="总长度">
      </el-table-column>
        ...
        <template slot-scope="scope">
          <el-dropdown trigger="click" @command="goTo">
            ...
            <el-dropdown-menu slot="dropdown">
              ...
              <el-dropdown-item command="正线坡度管理">正线坡度管理</el-dropdown-item>
              <el-dropdown-item command="曲线管理">曲线管理</el-dropdown-item>
