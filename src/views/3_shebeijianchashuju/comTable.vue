...
<template>
  <div class="">
    ...
    <el-table :data="tableData" style="width: 100%">
      ...
      <el-table-column prop="bankuai" label="板块">
      </el-table-column>
      <el-table-column prop="chejian" label="车间">
      </el-table-column>
      ...
      <el-table-column prop="binghaibuwei" label="病害部位">
      </el-table-column>
      <el-table-column prop="binghaileixing" label="病害类型">
      </el-table-column>
      <el-table-column prop="binghaiyuan" label="病害源">
      </el-table-column>
      <el-table-column prop="jiancharen" label="检查人">
      </el-table-column>
      <el-table-column prop="jianchariqi" label="检查日期" width="160">
      </el-table-column>
