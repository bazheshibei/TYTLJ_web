...
<template>
  <div class="">
    ...
    <el-table :data="tableData" style="width: 100%">
      ...
      <el-table-column prop="chadaobianhao" label="编号">
      </el-table-column>
      <el-table-column prop="chejian" label="车间">
      </el-table-column>
      <el-table-column prop="xianming" label="线名">
      </el-table-column>
      <el-table-column prop="chezhan" label="车站">
      </el-table-column>
      <el-table-column prop="chadaoleixing" label="岔道类型">
      </el-table-column>
      <el-table-column prop="yunxingzhuangtai" label="运营状态">
      </el-table-column>
      <el-table-column prop="xianbie" label="线别">
      </el-table-column>
      <el-table-column prop="pusheniandu" label="铺设年度">
      </el-table-column>
